...
namespace StyleBay_Version2.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(ApplicationDbContext context, IWebHostEnvironment env, IDressService dressService, IPriceCategoryService priceCategoryService, IDressCategoryService dressCategoryService, IOrderService orderService)
        {
            _context = context;
            _env = env;
        ...
        public IActionResult Dashboard()
        {
            ...
            ViewBag.TotalOrders = _context.Orders.Count();//need to vhange
